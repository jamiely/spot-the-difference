...
describe('DebugMenu', () => {
  ...
  beforeEach(() => {
    ...
    debugMenu = new DebugMenu(mockGame);
  });
  ...
  describe('initialization', () => {
    it('should initialize with correct default state', () => {
      expect(debugMenu.isVisible).toBe(false);
      expect(debugMenu.game).toBe(mockGame);
    });
    ...
    it('should set up event listeners on construction', () => {
      ...
      expect(() => new DebugMenu(mockGame)).not.toThrow();
    });
  });
  ...
  describe('keyboard shortcuts', () => {
    it('should toggle debug menu when ? key is pressed', () => {
      ...
      expect(debugMenu.isVisible).toBe(true);

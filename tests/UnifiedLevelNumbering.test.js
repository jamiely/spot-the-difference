...
describe('Unified Level Numbering', () => {
    ...
    beforeEach(() => {
        ...
        mockTemplateManager = {
            loadAvailableTemplates: vi.fn().mockResolvedValue([
                { name: 'template1', background: 'bg1.png' },
                { name: 'template2', background: 'bg2.png' },
                { name: 'template3', background: 'bg3.png' }
            ])
        };
        ...
        mockBackgroundLoader = {
            loadAvailableBackgrounds: vi.fn().mockResolvedValue([
                { filename: 'bg1.png' }, // Used by template1
                { filename: 'bg2.png' }, // Used by template2
                { filename: 'bg3.png' }, // Used by template3
                { filename: 'bg4.png' }, // Available for random
                { filename: 'bg5.png' }  // Available for random
            ])
        };
        
        levelManager = new LevelManager(mockTemplateManager, mockBackgroundLoader);
    });
    ...
    describe('Template phase progression', () => {
        it('should show unified numbering during template phase', async () => {
            ...
            let levelInfo = levelManager.getLevelInfo();

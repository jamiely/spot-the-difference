...
import type { BackgroundContext } from '../js/utils/SpritePositioning.js';
import type { TemplateData, Dimensions } from '../src/types/index.js';
...
interface MockTemplate extends TemplateData {
...
describe('SpritePositioning', () => {
  ...
  let mockSpriteElement: MockElement;
  ...
  describe('getActiveBackgroundContext', () => {
    it('should return game mode context when placement mode is not active', () => {
      const context: BackgroundContext = SpritePositioning.getActiveBackgroundContext();
    ...
    it('should return placement mode context when placement mode is active', () => {
      (global.document.body.classList.contains as any).mockReturnValue(true);
  ...
  describe('positionSpriteAtBackgroundCoords', () => {
    it('should position sprite using background-relative coordinates', () => {
      SpritePositioning.positionSpriteAtBackgroundCoords(
        mockSpriteElement as any, 10, 20, mockBackgroundImg, mockContainer
      );
    ...
    it('should auto-detect context when not provided', () => {
      SpritePositioning.positionSpriteAtBackgroundCoords(
        mockSpriteElement as any, 10, 20
      );
  ...
  describe('getSpritePosition', () => {
    it('should get sprite position from CSS styles', () => {
      ...
      const result = SpritePositioning.getSpritePosition(
        mockSpriteElement as any, mockBackgroundImg, mockContainer
      );
  ...
  describe('createCollisionDetector', () => {
    it('should detect collisions between sprites', () => {
      ...
      const detector: CollisionDetector = SpritePositioning.createCollisionDetector(
  ...
  describe('positionSpriteWithScaling', () => {
    it('should position sprite with scaling when template has background dimensions', () => {
      ...
      mockBackgroundImg.getBoundingClientRect = vi.fn(() => ({
        left: 100,
        top: 50,
        width: 320, // 80% of 400
      ...
      SpritePositioning.positionSpriteWithScaling(
        mockSpriteElement as any, 
        templateCoords as any, 
        mockTemplate as any, 
        mockBackgroundImg, 
        mockContainer
      );
